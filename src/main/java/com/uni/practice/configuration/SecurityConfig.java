package com.uni.practice.configuration;


import com.uni.practice.exception.jwt.JwtAccessDeniedHandler;
import com.uni.practice.exception.jwt.JwtAuthenticationEntryPoint;
import com.uni.practice.exception.jwt.TokenProvider;
   ...
   // protected void configure(HttpSecurity http) throws Exception {
         ...
         http.csrf().disable()
                ...
                // 시큐리티는 기본적으로 세션을 사용하지만 API 서버에선 세션을 사용하지 않기 때문에 세션 설정을 Stateless 로 설정
                 .exceptionHandling()
                 .authenticationEntryPoint(jwtAuthenticationEntryPoint)// 인증실패 했을때
